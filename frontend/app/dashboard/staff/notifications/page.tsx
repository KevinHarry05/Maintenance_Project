    ...
    <div className="space-y-8 max-w-4xl">
      <div className="flex items-center justify-between">
        <div>
          ...
          <p className="text-muted-foreground">Task assignments and updates</p>
        </div>
        {unreadCount > 0 && (
      ...
      {isLoading ? (
        ...
        <Card className="bg-card border-border p-12 text-center">
          ...
          <p className="text-muted-foreground">You&apos;ll receive notifications for new task assignments here.</p>
        </Card>
      )}
    </div>
  );
